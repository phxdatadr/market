...
class ZipcodesControllerTest < ActionController::TestCase
  ...
  test "should create zipcode" do
    assert_difference('Zipcode.count') do
      post :create, zipcode: { areacode: @zipcode.areacode, cityStName: @zipcode.cityStName, countOfCity: @zipcode.countOfCity, county: @zipcode.county, details: @zipcode.details, lastLineCity: @zipcode.lastLineCity, lat: @zipcode.lat, lat_degree: @zipcode.lat_degree, lon_degree: @zipcode.lon_degree, long: @zipcode.long, state: @zipcode.state, timeZoneLabel: @zipcode.timeZoneLabel, zip: @zipcode.zip }
    end
  ...
  test "should update zipcode" do
    patch :update, id: @zipcode, zipcode: { areacode: @zipcode.areacode, cityStName: @zipcode.cityStName, countOfCity: @zipcode.countOfCity, county: @zipcode.county, details: @zipcode.details, lastLineCity: @zipcode.lastLineCity, lat: @zipcode.lat, lat_degree: @zipcode.lat_degree, lon_degree: @zipcode.lon_degree, long: @zipcode.long, state: @zipcode.state, timeZoneLabel: @zipcode.timeZoneLabel, zip: @zipcode.zip }
    assert_redirected_to zipcode_path(assigns(:zipcode))
  end
